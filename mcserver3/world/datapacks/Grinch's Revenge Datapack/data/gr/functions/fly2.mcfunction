...
execute if entity @s[tag=bullet] positioned ~ ~ ~ run execute if entity @e[tag=mob,distance=0..1] run scoreboard players add @s bulletdmg 2
execute if entity @s[tag=bullet] positioned ~ ~-1 ~ run execute if entity @e[tag=mob,distance=0..1,nbt=!{IsBaby:1b}] run scoreboard players add @s bulletdmg 2
