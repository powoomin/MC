schedule function starter:2t2 2t
execute as @e[type=armor_stand,tag=movemob,tag=goomba] at @s run summon falling_block ~ ~ ~ {BlockState:{Name:"lime_glazed_terracotta",Properties:{facing:"east"}},NoGravity:1b,Time:-1,DropItem:0b,HurtEntities:0b}
...
execute as @e[type=armor_stand,tag=movemob,tag=bob_omb,tag=right] at @s run summon falling_block ~ ~ ~ {BlockState:{Name:"black_glazed_terracotta",Properties:{facing:"east"}},NoGravity:1b,Time:-1,DropItem:0b,HurtEntities:0b}
...
execute as @e[type=armor_stand,tag=movemob,tag=bob_omb,tag=left] at @s run summon falling_block ~ ~ ~ {BlockState:{Name:"black_glazed_terracotta",Properties:{facing:"west"}},NoGravity:1b,Time:-1,DropItem:0b,HurtEntities:0b}
...
execute as @e[type=armor_stand,tag=movemob,tag=koopa,tag=right] at @s if entity @a[distance=..25] run summon falling_block ~ ~ ~ {BlockState:{Name:"green_glazed_terracotta",Properties:{facing:"west"}},NoGravity:1b,Time:-1,DropItem:0b,HurtEntities:0b}
execute as @e[type=armor_stand,tag=movemob,tag=koopa,tag=left] at @s if entity @a[distance=..25] run summon falling_block ~ ~ ~ {BlockState:{Name:"green_glazed_terracotta",Properties:{facing:"east"}},NoGravity:1b,Time:-1,DropItem:0b,HurtEntities:0b}
