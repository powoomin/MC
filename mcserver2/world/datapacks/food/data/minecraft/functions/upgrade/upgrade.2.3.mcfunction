scoreboard players set level.2 upgrade 3
setblock -8 82 -2 jungle_wall_sign[facing=west,waterlogged=false]
...
data merge block -8 82 -2 {Text3:'[{"text":"골드 : ","color":"yellow"},{"text":"50","color":"gold","italic":true,"bold":true}]'}
data merge block -8 82 -2 {Text4:'[{"text":"4개 ","color":"gray"},{"text":"-> ","color":"white"},{"text":"6개","color":"green"}]'}
