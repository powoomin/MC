scoreboard players set level.6 upgrade 2
setblock -8 82 7 oak_wall_sign[facing=west,waterlogged=false]
...
data merge block -8 82 7 {Text3:'[{"text":"골드 : ","color":"yellow"},{"text":"75","color":"gold","italic":true,"bold":true}]'}
